...
export default function PlanDetailPage() {
  ...
  const addedPlaceId = (location.state as { addedPlaceId?: string } | null)?.addedPlaceId;
      ...
      <div className="max-w-lg mx-auto px-4 pt-5 flex flex-col gap-4">
            ...
            <div className="flex flex-col gap-2">
              <div className="relative">
                ...
                <input
                  ...
                  onClick={() => navigate(`/mapa?planId=${plan.id}`)}
                  readOnly
              ...
              <button
                ...
                className="w-full flex items-center justify-center gap-2 bg-white text-slate-700
                           text-sm font-bold py-3 rounded-xl hover:bg-slate-50 border border-slate-200
            ...
            {sorted.map((sub, index) => (
              <div key={sub.id}
                   className={`bg-white border rounded-2xl p-4 shadow-sm
                              ...
                              ${sub.placeId && sub.placeId === addedPlaceId
        ...
        {sorted.length === 0 && !showAdd && (
          <div className="bg-white border border-slate-200 rounded-2xl text-center py-12 px-6 shadow-sm">
            <p className="soft-icon mx-auto mb-3">M</p>

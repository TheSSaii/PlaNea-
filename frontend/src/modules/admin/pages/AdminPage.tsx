...
const TRANSPORT_OPTIONS: { value: TransportType; label: string; icon: string }[] = [
  ...
  { value: 'PUBLIC',   label: 'Transporte publico', icon: 'P' },
...
const STAT_ICONS: Record<string, string> = {
  Total: 'T', Borrador: 'B', Futuros: 'F', Pasados: 'P', Usuarios: 'U',
};
            ...
            {[
              ...
              <div key={s.label}
                ...
                <div className="flex items-center justify-between mb-3">
                  ...
                  <span className="inline-icon">{STAT_ICONS[s.label]}</span>
                </div>
              ...
              <div>
                ...
                <div className="grid grid-cols-3 gap-2">
                  {TRANSPORT_OPTIONS.map(opt => (
                    ...
                    >
                      <span className="inline-icon">{opt.icon}</span>
